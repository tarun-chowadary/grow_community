/*
  # Create Complete Schema for Grow Community Platform
  
  1. New Tables
    - profiles - User profiles with role information (buyer/seller)
    - shops - Shop information for sellers
    - products - Products offered by shops
    - offers - Promotional offers from shops
    - reviews - Customer reviews for shops
  ...
  2. Security
    ...
    - Buyers can view shops and place orders
    - All users can leave reviews
*/
...
CREATE POLICY "Buyers can view active offers"
...
CREATE POLICY "Shop owners can delete offers"
